...
use gmn_api_routes::{
    exercise::{
        ...
        delete::delete_feed_post, get::{get_explore_posts, get_feed_posts, get_post, get_posts_from_user}, post::{like_feed_post, new_post}, put::update_feed_post
